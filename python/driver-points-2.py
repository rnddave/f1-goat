...
data = {
    ...
    'Nigel Mansell', 'Nelson Piquet', 'Jackie Stewart', 'Jack Brabham',
    'Graham Hill', 'Emerson Fittipaldi', 'Mika Häkkinen', 'Alberto Ascari',
    'Jim Clark', 'Niki Lauda', 'Damon Hill', 'Jacques Villeneuve',
    'Juan Manuel Fangio', 'Stirling Moss', 'Alberto Ascari', 'Giuseppe Farina',
    'Mike Hawthorn', 'Phil Hill', 'John Surtees', 'Denny Hulme',
    'Jochen Rindt', 'James Hunt', 'Mario Andretti', 'Jody Scheckter',
    'Alan Jones', 'Keke Rosberg', 'Michele Alboreto', 'Riccardo Patrese',
    'Jean Alesi', 'Gerhard Berger', 'Heinz-Harald Frentzen', 'Jarno Trulli',
    'Ralf Schumacher', 'Nick Heidfeld', 'Robert Kubica', 'Vitaly Petrov',
    'Pastor Maldonado', 'Mark Webber', 'Sebastian Buemi', 'Jean-Eric Vergne',
    'Carlos Sainz', 'Charles Leclerc', 'Pierre Gasly', 'Esteban Ocon',
    'Lando Norris', 'George Russell', 'Nicholas Latifi', 'Yuki Tsunoda',
    'Mick Schumacher', 'Nikita Mazepin', 'Kevin Magnussen', 'Romain Grosjean',
    'Marcus Ericsson', 'Jules Bianchi', 'Esteban Gutierrez', 'Max Chilton',
    'Kamui Kobayashi', 'Sergio Perez', 'Charles Pic', 'Timo Glock',
    'Adrian Sutil', 'Vitantonio Liuzzi', 'Sebastian Vettel', 'Lewis Hamilton',
    'Jenson Button', 'Fernando Alonso', 'Kimi Räikkönen', 'Felipe Massa',
    'Nico Rosberg', 'Michael Schumacher', 'Rubens Barrichello', 'David Coulthard',
    'Mika Häkkinen', 'Johnny Herbert', 'Eddie Irvine', 'Heinz-Harald Frentzen',
    'Damon Hill', 'Jacques Villeneuve', 'Giancarlo Fisichella', 'Jarno Trulli',
    'Jean Alesi', 'Gerhard Berger', 'Olivier Panis', 'Martin Brundle',
    'Ukyo Katayama', 'Jos Verstappen', 'Mika Salo', 'Pedro Diniz',
    'Jean-Christophe Boullion', 'Johnny Dumfries', 'Pierluigi Martini',
    'Stefan Johansson', 'Nigel Mansell', 'Ayrton Senna', 'Alain Prost',
    'Nelson Piquet', 'Keke Rosberg', 'Niki Lauda', 'Carlos Reutemann',
    'Jacques Laffite', 'Mario Andretti', 'Jody Scheckter', 'Alan Jones',
    'John Watson', 'Patrick Tambay', 'Gilles Villeneuve', 'Didier Pironi',
    'Riccardo Patrese', 'Elio de Angelis', 'Andrea de Cesaris', 'Rene Arnoux',
    'Jean-Pierre Jarier', 'Derek Daly', 'Hector Rebaque', 'Marc Surer',
    'Teo Fabi', 'Philippe Alliot', 'Thierry Boutsen', 'Piercarlo Ghinzani',
    'Ivan Capelli', 'Nicola Larini', 'Alex Caffi', 'Roberto Moreno',
    'Gabriele Tarquini', 'Emanuele Pirro', 'JJ Lehto', 'Eric van de Poele',
    'Andrea Chiesa', 'Giovanna Amati', 'Karl Wendlinger', 'Heinz-Harald Frentzen',
    'Michael Andretti', 'Jos Verstappen', 'Mika Salo', 'Damon Hill',
    'Rubens Barrichello', 'Michael Schumacher', 'Jacques Villeneuve', 'David Coulthard',
    'Ralf Schumacher', 'Juan Pablo Montoya', 'Jarno Trulli', 'Heinz-Harald Frentzen',
    'Giancarlo Fisichella', 'Eddie Irvine', 'Mika Häkkinen', 'Jenson Button',
    'Takuma Sato', 'Nick Heidfeld', 'Kimi Räikkönen', 'Felipe Massa',
    'Fernando Alonso', 'Mark Webber', 'Sebastian Vettel', 'Lewis Hamilton',
    'Nico Rosberg', 'Michael Schumacher', 'Robert Kubica', 'Vitaly Petrov',
    'Paul di Resta', 'Adrian Sutil', 'Kamui Kobayashi', 'Sergio Perez',
    'Bruno Senna', 'Pastor Maldonado', 'Romain Grosjean', 'Jean-Eric Vergne',
    'Daniel Ricciardo', 'Max Verstappen', 'Carlos Sainz', 'Kevin Magnussen',
    'Daniil Kvyat', 'Esteban Ocon', 'Lance Stroll', 'Charles Leclerc',
    'Pierre Gasly', 'Lando Norris', 'George Russell', 'Nicholas Latifi',
    'Yuki Tsunoda', 'Mick Schumacher', 'Nikita Mazepin', 'Zhou Guanyu',
    'Nyck de Vries', 'Oscar Piastri', 'Logan Sargeant',
    ],
    'Points': [
        4138, 1566, 3098, 1873, 
        2061, 614, 798, 1235, 
